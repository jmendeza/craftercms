#!/usr/bin/env bash
#
# Sync monorepo modules from the legacy per-repo support/4.x branches.
#
# For each module, fetches https://github.com/craftercms/<module> (support/4.x)
...
Options:
  ...
  -b, --branch <name>     Branch to sync (default: support/4.x)
